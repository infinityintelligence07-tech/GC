-- IAM sync: não sobrescreve financeiro Kamino em fichas que já têm parcelas.
-- Kamino permanece fonte da verdade para valores em aberto / pagos.
...
COMMENT ON FUNCTION public.iam_control_upsert_one_contract(jsonb, text, jsonb, text) IS
  'Upsert IAM→GC por treinamento. Em UPDATE, preserva financeiro Kamino quando a ficha já tem parcelas.';
